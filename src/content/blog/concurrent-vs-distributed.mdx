...
jsonLD: {
    ...
    "@type": "TechArticle",
    "headline": "Concurrent vs Distributed Systems",
    "description": "How is it that your computer can’t handle a few chrome tabs while hotstar can serve millions of users simultaneously? Understand the difference between concurrent and distributed systems.",
    "author": {
      "@type": "Person",
      "name": "Rishab Raj"
    },
    ...
    "about": [
      {
        "@type": "DefinedTerm",
        "name": "Concurrency",
        "sameAs": "https://en.wikipedia.org/wiki/Concurrency_(computer_science)"
      },
      {
        "@type": "DefinedTerm",
        "name": "Distributed computing",
        "sameAs": "https://en.wikipedia.org/wiki/Distributed_computing"
      }
    ],
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://rishab49.github.io/blog/concurrent-vs-distributed-systems" 
    }
}
---
